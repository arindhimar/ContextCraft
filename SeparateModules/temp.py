...
# ─── Configuration ─────────────────────────────────────────────────────────────
API_KEY      = "nah"
ACCESS_TOKEN = "im good"
EXCHANGE     = "NSE"      # default segment; change to "BSE" if needed
PRODUCT      = "CNC"      # intraday by default; use "CNC" for delivery
VARIETY      = "regular"  # order variety
# ───────────────────────────────────────────────────────────────────────────────

def place_trade(kite, symbol_substr, qty, side, price=None):
    # 1) fetch instruments for configured exchange
    ...
    # choose first match (you could add more logic here)
    inst = matches[0]
